...
RELEVANCE_PROMPT_VERSION = "intco-relevance-v4"
BUSINESS_ANALYSIS_PROMPT_VERSION = "intco-business-analysis-v4"
REPORT_PROMPT_VERSION = "intco-daily-report-v4"
...
DEFAULT_BUSINESS_PROFILE = """企业主体：英科医疗是一家全球化医疗制造企业，主要收入和经营风险来自下列产品及其全球产业链、客户和监管环境。
